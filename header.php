                                        ...
                                        <ul class="navigation clearfix">
                                            ...
                                            <li class="dropdown"><a href="#">Services</a>
                                                <ul>
                                                    ...
                                                    <li><a href="solar_plants.php">Solar Plants</a></li>
                                                    <li><a href="mosquito_net.php">Mosquito Net</a></li>
                                                    <li><a href="pigeon_net.php">Pigeon Net</a></li>
                                                    <li><a href="upvc_windows.php">UPVC Windows</a></li>
                                                   
                                                </ul>
                                            </li>
                                            <li class="dropdown"><a href="#">Residential</a>
                                                <ul>
                                                    <!-- <li><a href="<?php echo BASE_PATH."/residential"?>">All Services</a></li> -->
                                                    <li><a href="pop.php">POP</a></li>
                                                    <li><a href="lights.php">Lights</a></li>
                                                    <li><a href="flooring.php">Flooring</a></li>
                                                    <li><a href="electricals.php">Electricals</a></li>
                                                    <li><a href="paintings.php">Painting</a></li>
                                                    <li><a href="interior_design.php">Interior Designing</a></li>
                                                    <li><a href="upvc_windows.php">UPVC Windows</a></li>
                                            ...
                                            <li class="dropdown"><a href="#">Commercial</a>
                                                <ul>
                                                    <!-- <li><a href="
                                                    <?php echo BASE_PATH."/commercial"?>
                                                    ">All Services</a></li> -->
                                                    <li><a href="glass_cabins.php">Glass Cabins</a></li>
                                                    <li><a href="glass_partitions.php">Glass Partitions</a></li>
                                                    <li><a href="aluminium_partitions.php">Alluminium Partitions</a></li>
                                                    <li><a href="wooden_partitions.php">Wooden Partitions</a></li>
                                                    <li><a href="work_stations.php">Work Stations</a></li>
                                                    <li><a href="reception_tables.php">Reception Tables</a></li>
                                                    <li><a href="visitor_chairs.php">Visitor Chairs</a></li>
                                                    <li><a href="rolling_chairs.php">Rolling Chairs</a></li>
                                                    <li><a href="executive_chairs.php">Executive Chairs</a></li>
